...
public class WelcomeTest {
    ...
    public void testWelcomeCase4() {
        ...
        assertEquals("Hello, Amy and Bob", result);
    }

    @Test
    public void testWelcomeCase5() {
        String result = Welcome.Welcome("Amy, bob,jerry");
        assertEquals("Hello, Amy, Bob and Jerry", result);
    }

    @Test
    public void testWelcomeCase6() {;
        String result = Welcome.Welcome("Amy, BOB, Jerry");
        assertEquals("Hello, Amy and Jerry. AND HELLO, BOB !", result);
    }
    ...
    public void testWelcomeCase11() {
        String result = Welcome.Welcome("bob, yoda, amy");
        assertEquals("Bob, Yoda, and Amy, Hello.", result);
    }
